...
add_action('admin_footer-dashboard_page_wp-serverinfo/wp-serverinfo', 'serverinfo_footer');
function serverinfo_footer() {
	wp_register_script('wp-serverinfo', plugins_url('wp-serverinfo/serverinfo-js.js'), array('jquery'), '1.50');
	echo "\n".'<!-- Start Of Script Generated By WP-ServerInfo 1.50 -->'."\n";
	wp_print_scripts('wp-serverinfo');
	echo '<!-- End Of Script Generated By WP-ServerInfo 1.50 -->'."\n";
}
