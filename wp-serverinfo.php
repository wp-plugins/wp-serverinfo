...
function serverinfo_head() {
	wp_register_script('wp-serverinfo', '/wp-content/plugins/wp-serverinfo/serverinfo-js-packed.js', false, '1.30');
	echo "\n".'<!-- Start Of Script Generated By WP-ServerInfo 1.30 -->'."\n";
	wp_print_scripts('wp-serverinfo');
	echo '<!-- End Of Script Generated By WP-ServerInfo 1.30 -->'."\n";
}
